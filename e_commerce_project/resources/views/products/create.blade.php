<x-app-layout active="products">
    <x-slot name="header">
        ...
        <p class="text-sm text-gray-500">Fill in the form below to add a new product to your inventory.</p>
    </x-slot>
    ...
    <div class="py-8 max-w-3xl mx-auto">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md space-y-4">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" 
                          class="mt-1 block w-full border-gray-300 rounded-md p-2 focus:ring-rose-500 focus:border-rose-500">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="flex justify-end space-x-2">
                ...
                <button type="submit" class="px-4 py-2 bg-rose-600 text-white rounded hover:bg-rose-700">Add Product</button>
            </div>
        </form>
    </div>
</x-app-layout>
